<!--first chunk determins if browser is mobile or desktop-->
<!--second chunk decides if user is admin or not-->
<?php
session_start();
...
<html>
	...
	<body>
		...
		<!--uses first bit of php to determin if browser is mobile display this page-->
		...
		<!--uses first php to determin if browser is not mobile then it will display this html/css-->
		<?php } else { ?>
